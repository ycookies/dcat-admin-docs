...
![](../guide/images/multi-widgets/CardWidget.png ':size=60%')
  ```php
  ...
  ```
#### CoverCard 页面组件
![](../guide/images/multi-widgets/2.png)
...
```
#### 列表折叠 页面组件
![](../guide/images/multi-widgets/3.png ':size=60%')
```php
...
```
#### 轮播图 页面组件
![](../guide/images/multi-widgets/4.png ':size=60%')
```php
...
```
#### linkbox 页面组件
![](../guide/images/multi-widgets/5.jpeg ':size=60%')
```php
$link_group = [
            [
                'icon'      => '图标',
...
```
#### 媒体列表 页面组件
![](../guide/images/multi-widgets/6.png ':size=60%')
```php
...
```
#### 订价卡 页面组件
![](../guide/images/multi-widgets/7.png ':size=60%')
```php
...
```
#### 时间轴 页面组件
![](../guide/images/multi-widgets/8.png ':size=60%')
```php
$datalist = [
            [
                'title'    => '标题', 
...
```
#### Functional 页面组件
![](../guide/images/multi-widgets/9.png ':size=60%')
```php
...
#### Remark 页面组件
![](../guide/images/multi-widgets/10.png ':size=60%')
```php
...
![](../guide/images/multi-widgets/author.png ':size=20%')
...
![Alt](../guide/images/weixinpay2.jpg ':size=20%')
