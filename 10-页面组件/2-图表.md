...
效果
![](https://cdn.learnku.com/uploads/images/202004/26/38389/8uS1kt7oAb.png!large)
...
效果
![](https://cdn.learnku.com/uploads/images/202004/26/38389/UDrNU9UxfM.png!large)
...
```
### 注意事项
当使用图表时，数据本身是整数，可展示出来是小数，比如 2，展示出来变成了 2.0。可以加上如下代码解决。
```php
$this->chartOption(
    'yaxis.labels',//这个值最后段代码会作为JS代码执行
    ['formatter'=> \Dcat\Admin\Support\JavaScript::make("function(val){return parseInt(val,10);}")]);
```
### 使用日期区间筛选 
> data-plus: Since `v1.4.3`

```php
$this->dateRange();
```
效果
![](../guide/images/jietu/WechatIMG3230.jpg ':size=50%')
